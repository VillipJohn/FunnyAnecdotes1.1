...
public class AnecdoteFavoriteCategoryFragment extends Fragment implements View.OnTouchListener, View.OnClickListener {
    ...
    public ImageView left, right, home, basket;
    ...
    public AnecdoteFavoriteCategoryFragment() {
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
       ...
       /* Cursor checkCursor = myDbHelper.query(DataBaseHelper.TABLE_NAME, new String[]{DataBaseHelper.KEY_ID, DataBaseHelper.KEY_FAVORITE, DataBaseHelper.KEY_TEXT, DataBaseHelper.KEY_VIEWED},
                "CATEGORY = ?",
...
*/
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_anecdote_favorite_category, container, false);
        ...
        if (textAnecdote != null) {
            ...
            basket = (ImageView) rootView.findViewById(R.id.imgBtnBasket);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.imgBtnFavorite:
                ...
                myDbHelper.updateViewed(DataBaseHelper.TABLE_NAME, values, DataBaseHelper.KEY_ID + " = ?", new String[] {Integer.toString(cursor.getInt(4))});
    ...
    private void onNextAnecdote() {
        if((cursor.getInt(0) != countAnecrotesInCategory) && cursor.moveToNext()) {
            textAnecdote = cursor.getString(2);
            textViewAnecdote.setText(textAnecdote);
    ...
    private void onPreviousAnecdote() {
        if((cursor.getInt(0) != 1)  && cursor.moveToPrevious()) {
            textAnecdote = cursor.getString(2);
            textViewAnecdote.setText(textAnecdote);
